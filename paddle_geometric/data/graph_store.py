...
class GraphStore(ABC):
    ...
    def coo(self, edge_types: Optional[List[Any]] = None,
    ...
    def csr(self, edge_types: Optional[List[Any]] = None,
            store: bool = False) -> ConversionOutputType:
        """Returns the edge indices in the :class:`GraphStore` in CSR format.
    ...
    def csc(self, edge_types: Optional[List[Any]] = None,
            store: bool = False) -> ConversionOutputType:
        """Returns the edge indices in the :class:`GraphStore` in CSC format.
    ...
    def _edge_to_layout(
            self, attr: EdgeAttr, layout: EdgeLayout, store: bool = False
        ...
        if edge_types is not None:
            for edge_type in edge_types:
                if edge_type not in edge_type_attrs:
                    raise ValueError(
                        f"The 'edge_index' of type '{edge_type}' was not found in the graph store."
                    )
            edge_type_attrs = {
                key: attr
